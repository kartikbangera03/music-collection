...
router.get("/", dashBoardControlller.getDashBoard )
...
router.post("/release/:id/delete", releaseController.deleteReleaseById);
...
router.post("/searchResults" , searchController.getSearchResults);
